...
import { LoaderCircle, ChevronRight, DownloadIcon } from "lucide-react";
...
export const Results: React.FC<{ data: FormData }> = ({ data }) => {
	...
	const handleDownloadPDF = async () => {
		...
		try {
			...
			if (response.ok) {
				...
				a.href = url;
				a.download = `financial_check_${consultationCode || 'preview'}.pdf`;
	...
	return (
		<div className="space-y-6">
					...
					{!saveSuccess ? (
						...
						<div className="text-center space-y-4">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                {/* FIX: PDF Download Button wieder hinzugefügt */}
                                <Button
                                    onClick={handleDownloadPDF}
                                    disabled={isDownloadingPDF}
                                    variant="outline"
            ...
            {/* Rest der Komponente (Charts, Detail-Analyse) */}
			...
			<Card className="shadow-sm">
				<CardHeader>
					<CardTitle>Ihr Gutmann Kompass</CardTitle>
				</CardHeader>
